    ...
    <footer className="site-footer">
      <div
        ...
        <div>
          ...
          <p style={{ margin: "0 0 12px 0", fontSize: "0.9rem", color: "var(--muted)", fontWeight: 500 }}>✉ asr082239@gmail.com</p>
          <p style={{ margin: 0, fontSize: "0.9rem", color: "var(--muted)", fontWeight: 500 }}>📱 +91 9603230138</p>
        </div>
