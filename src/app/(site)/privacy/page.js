          ...
          <Reveal>
            <div style={{ display: "flex", flexDirection: "column", gap: "36px", color: "var(--primary)", lineHeight: "1.7", fontSize: "1rem" }}>
              ...
              <div>
                ...
                <p style={{ color: "var(--muted)", margin: 0 }}>
                  If you have questions about our privacy policies or want to request the removal of your personal information from our CRM, please contact us at <a href="mailto:nexhydigital@gmail.com" style={{ color: "var(--accent)", textDecoration: "none", fontWeight: 600 }}>nexhydigital@gmail.com</a> or visit our office in Hyderabad, India.
                </p>
              </div>
